...
ENV LANGSERVE_GRAPHS='{"multi_agent_supervisor": "/deps/deploy-langgraph-server-auth/src/supervisor/graph.py:graph","tools_agent": "/deps/deploy-langgraph-server-auth/src/tools_agent/graph.py:graph"}'
